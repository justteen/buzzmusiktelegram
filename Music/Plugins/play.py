...
"""
        ...
        link = "https://t.me/psycho_syridwan"
...
¹ <b>{title1[:65]}</b>
  ╠ ❒ [RAHASIA AHH](https://t.me/{BOT_USERNAME}?start=info_{ID1})
  ╚ ❒ **{BOT_NAME}**

² <b>{title2[:65]}</b>
  ╠ ❒ [RAHASIA AHH](https://t.me/{BOT_USERNAME}?start=info_{ID2})
  ╚ ❒ **{BOT_NAME}**

³ <b>{title3[:65]}</b>
  ╠ ❒ [RAHASIA AHH](https://t.me/{BOT_USERNAME}?start=info_{ID3})
  ╚ ❒ **{BOT_NAME}**
